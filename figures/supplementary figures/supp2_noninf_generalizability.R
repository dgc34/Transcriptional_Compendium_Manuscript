...
input_file <- '~/Dropbox/big_eval_heatmap_list_generalizability_021322_noninf_sbj_ts.RDS'
...
pdf('~/Dropbox/compendium_manuscript/figures/supplements/supp2.pdf', height = 7, width = 4.5)
op1
dev.off()
